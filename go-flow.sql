...
-- ----------------------------
-- Table structure for flow_cate
-- ----------------------------
DROP TABLE IF EXISTS `flow_cate`;
CREATE TABLE `flow_cate`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `delete_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程分类表' ROW_FORMAT = Dynamic;

...
var (
	...
	FlowCateModel        *flowCateModel
	FlowFormModel        *flowFormModel
)
...
func SetDefault(db *gorm.DB, opts ...gen.DOOption) {
	*Q = *Use(db, opts...)
	...
	FlowCateModel = &Q.FlowCateModel
	FlowFormModel = &Q.FlowFormModel
}
...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		FlowCateModel:        newFlowCateModel(db, opts...),
		FlowFormModel:        newFlowFormModel(db, opts...),
	}
}
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		FlowCateModel:        q.FlowCateModel.clone(db),
		FlowFormModel:        q.FlowFormModel.clone(db),
	}
}
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		FlowCateModel:        q.FlowCateModel.replaceDB(db),
		FlowFormModel:        q.FlowFormModel.replaceDB(db),
	}
}
...
type queryCtx struct {
	...
	FlowCateModel        IFlowCateModelDo
	FlowFormModel        IFlowFormModelDo
}
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		FlowCateModel:        q.FlowCateModel.WithContext(ctx),
		FlowFormModel:        q.FlowFormModel.WithContext(ctx),
	}
}
